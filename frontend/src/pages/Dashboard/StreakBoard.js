        ...
        <Card>
            ...
            <h4 className="card-title mb-4 ">Streak</h4>
                <Row className="text-center mt-1 py-4">
                    ...
                    <row p-5>
                        <Col md="3"></Col>
                        <Col md=""><button className="my-button">{`${data.activeDays}/${data.totalDays}`}</button></Col>
                        <Col md="3"></Col>
                    </row>
                    <h5 className="font-size-10">CURRENT STREAK/BEST STREAK</h5>
                    <row p-5>
                        <Col md="3"></Col>
                        <Col md=""><button className="my-button">{`${data.currentStreak}/${data.bestStreak}`}</button></Col>
                        <Col md="3"></Col>
                    </row>
                    <h5 className="font-size-10">HIGHEST STREAK(OVERALL)</h5>
                    <row p-5>
                        <Col md="3"></Col>
                        <Col md="12"><button className="my-button">{`${data.highestStreak}`}</button></Col>
                        <Col md="3"></Col>
                    </row>
                </Row>
            </CardBody>
